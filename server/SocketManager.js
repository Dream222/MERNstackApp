...
module.exports = function(socket){
	...
	socket.on(MESSAGE_SENT, ({activeChat, chatId, message})=>{
		...
		let insert_message = activeChat.messages[activeChat.messages.count-1]

		console.log(insert_message)
		// mongoDbHelper.collection("chat").findOne({id: insert_message.id})
		// .then((results) => {
		// 	console.log(results)
		// 	// if(!results){
		// 	// 	mongoDbHelper.collection("chat").insert(insert_message)
		// 	// }else{
		// 	// 	mongoDbHelper.collection("chat").update({_id:results._id},{$set: {messages: insert_message.messages}})
		// 	// }
